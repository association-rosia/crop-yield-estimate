...
from src.models.model_config import get_gridsearch
...
def parse_args() -> dict:
    ...
    parser.add_argument('--estimator_name', type=str, default='XGBRegressor', choices=['XGBRegressor'], help='Estimator to use.')
